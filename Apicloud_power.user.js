...
(function() {
    ...
    const ApicloudPower = {
        ...
        rendTimer: null,
        localstore: GM_getValue('ApicloudPowerStore') ? GM_getValue('ApicloudPowerStore') :{},
        curApp: {},
        curPlatform: 0,
        curPackType: 0,
        ...
        _bindLocationCheck: function(){
            setInterval(function(){
                ApicloudPower.localstore.location = (GM_getValue('ApicloudPowerStore') && GM_getValue('ApicloudPowerStore').location) ? GM_getValue('ApicloudPowerStore').location :'';
                ...
                if(ApicloudPower.localstore.location != location){
                    ...
                    GM_setValue('ApicloudPowerStore', ApicloudPower.localstore);
        ...
        _getSmartVerIos: function(){
            return (GM_getValue('ApicloudPowerStore') && GM_getValue('ApicloudPowerStore').pkgVerIos) ? GM_getValue('ApicloudPowerStore').pkgVerIos: ApicloudPower.curApp.pkgVer;
        },
        _getSmartVerAnd: function(){
            return (GM_getValue('ApicloudPowerStore') && GM_getValue('ApicloudPowerStore').pkgVerAnd) ? GM_getValue('ApicloudPowerStore').pkgVerAnd: ApicloudPower.curApp.pkgVer;
        },
        _smartVer: function(){
