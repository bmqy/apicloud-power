...
(function() {
    ...
    const ApicloudPower = {
        ...
        rendTimer: null,
        curApp: {},
        localstoreKey: 'ApicloudPowerStore'+ ApicloudPower.curApp.id,
        localstore: GM_getValue(localstoreKey) ? GM_getValue(localstoreKey) :{},
        curPlatform: 0,
        curPackType: 0,
        ...
        _bindLocationCheck: function(){
            setInterval(function(){
                ApicloudPower.localstore.location = (GM_getValue(localstoreKey) && GM_getValue(localstoreKey).location) ? GM_getValue(localstoreKey).location :'';
                ...
                if(ApicloudPower.localstore.location != location){
                    ...
                    GM_setValue(localstoreKey, ApicloudPower.localstore);
        ...
        _getSmartVerIos: function(){
            return (GM_getValue(localstoreKey) && GM_getValue(localstoreKey).pkgVerIos) ? GM_getValue(localstoreKey).pkgVerIos: ApicloudPower.curApp.pkgVer;
        },
        _getSmartVerAnd: function(){
            return (GM_getValue(localstoreKey) && GM_getValue(localstoreKey).pkgVerAnd) ? GM_getValue(localstoreKey).pkgVerAnd: ApicloudPower.curApp.pkgVer;
        },
        _smartVer: function(){
